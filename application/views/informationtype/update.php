						...
						<div class="row">
							<div class="col-md-4">
								<div class="form-group">
									...
									<input type="text" class="form-control" required value="<?= $data->e_type_name;?>" name="e_type_name" placeholder="Enter Type Information">
							...
							<div class="col-md-2">
								<div class="form-group">
									...
									<input type="color" class="form-control" required value="<?= str_replace("'","",$data->e_color);?>" name="e_color" placeholder="html code">
