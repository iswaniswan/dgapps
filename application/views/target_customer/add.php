									...
									<div class="row">
										...
										<div class="col-xl-12">
											<div class="form-group row">
												...
												<div class="col-lg-10">
													<input type="number" maxlength="4" min="<?= date('Y');?>" class="form-control" placeholder="YYYY" name="i_periode" required>
												</div>
											</div>
										</div>
										<div class="col-xl-12">
											<div class="form-group row" hidden>
												...
												<div class="col-lg-10">
													<input type="number" class="form-control" name="v_spb_target" value="0" placeholder="Rp. xxx.xxx.xxx.xxx">
												</div>
											</div>
											<div class="form-group row">
												<label class="col-form-label col-lg-2">Target MoU</label>
												<div class="col-lg-10">
													<input type="text" onkeyup="reformat(this);" class="form-control" name="v_nota_target" placeholder="Rp. xxx.xxx.xxx.xxx" required>
												</div>
											</div>
